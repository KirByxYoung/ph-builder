...
namespace IJunior.TypedScenes
{
    ...
    public class Game : TypedScene
    {
        ...
        public static void Load(ICastleLevel argument, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
        {
            LoadScene(_sceneName, loadSceneMode, argument);
        }
        
        public static UnityEngine.AsyncOperation LoadAsync(ICastleLevel argument, LoadSceneMode loadSceneMode = LoadSceneMode.Single)
        {
